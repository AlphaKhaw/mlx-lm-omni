...
class Model(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        text_model_path = hf_repo_to_path(args.text_model_id)
        text_model, _text_config = load_model(
            text_model_path, lazy=True, get_model_classes=get_thinker_classes
        )
    ...
    def build_custom_tokenizer(self, tokenizer: TokenizerWrapper) -> ExtendedTokenizer:
        return TokenizerWithAudio(
            ...
            tokenizer,
            self.text_model.model.embed_tokens,
        )
